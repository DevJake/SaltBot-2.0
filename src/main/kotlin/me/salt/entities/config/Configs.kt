...
//@JsonIgnoreType
data class Handler(private val chain: List<String> = emptyList(), private val entityId: String?) {
    var expectedPath = ""
    private var keyword = ""
    ...
    fun check() = apply {
        ...
        expectedPath += when (chain.get(1)) {
            ...
            else -> exception(ConfigHandlerException("The value at chain[1] is incorrect! Must be one of me.salt.entities.config.Configs.ConfigTypes"))
        }
