...
public enum Perm {
    ...
    //For me only!!
    CONFIGURE_GUILD_PERMISSIONS,
    //TODO give to guild owners by default
    CONFIGURE_TEXTCHANNEL_PERMISSIONS,
    CONFIGURE_USER_PERMISSIONS,
    //Give to every user by default
    CONFIG_SET_CMDPREFIX,
    //Let a user/guild change the cmd prefix
    CONFIG_SET_EMBED_COLOUR,
    //Let a user/guild change the embed colour
    CONFIG_BYPASS_CMD_PREFIX,
    //Let a user bypass a guild's cmd prefix
    CONFIG_BYPASS_EMBED_COLOUR,
    //Let a user bypass a guild's embed colour
    //ALIASES
    CONFIG_ADD_ALIAS,
    CONFIG_REMOVE_ALIAS,
    ...
    COMMAND_SAY_USE_MENTION_EVERYONE,
    //Mention @everyone
    COMMAND_SAY_USE_MENTION_HERE,
    //Mention @here
