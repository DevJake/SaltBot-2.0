...
public class EvalCommand extends Command implements ICommand {
    ...
    public void execute(CommandParser.ParsedCommandContainer cmd, GuildMessageReceivedEvent e) {
        ...
        try {
            ...
            e.getChannel()
             .sendMessage(new EmbedBuilder().addField("Evaluation was successful! ✅", n.toString(), false)
                                            .setColor(Main.salt.getEmbedColour())
                                            .setFooter(
                                                    "Requested by " + e.getAuthor().getName() + " at " + e.getMessage()
                                                                                                          .getCreationTime()
                                                                                                          .plusHours(1)
            ...
            //TODO log
            e.getChannel()
             .sendMessage(new EmbedBuilder().addField("Evaluation was unsuccessful! ❌", e1.getMessage(), false)
                                            .setColor(Main.salt.getEmbedColour())
                                            .setFooter(
                                                    "Requested by " + e.getAuthor().getName() + " at " + e.getMessage()
                                                                                                          .getCreationTime()
